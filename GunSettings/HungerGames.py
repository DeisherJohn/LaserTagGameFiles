...
if __name__ == '__main__':
    ...
    print 'how many guns?'
    gunNumber = raw_input('');gunNumber=int(gunNumber)
    if '' == gunNumber: gunNumber=0
        ...
        while 1: 
            ...
            for ii in packetHandler.captures:
                ...
                if ii.frame.msdu[2] == 32 or ii.frame.msdu[2] == 37: 
                    ...
                    print 'killed: %i' % len(killList),
                    os.system('ipython GunSettings/endGame.py %i' % killed)
                    
                    if gunNumber == 0:
                        print 
                    else:
                        print '(%i left)' % (gunNumber-len(killList))
                        if gunNumber-len(killList) == 1:
                            snifferDev.stop()
                            sys.exit(0)
