...
if __name__ == '__main__':
    ...
    print 'how many hits? [max of 50; default = 50]'
    gun1 = raw_input('')
    if '' == gun1: 
        hitLimit=50
    else:
    ...
    print 'time limit? [4 min.]'
    gun1 = raw_input('')
    if '' == gun1: 
        timeLimit=240
    else:
        timeLimit=float(gun1)*60
    ...
    try:
        while 1: 
            ...
            for ii in packetHandler.captures:
                ...
                if (ii.frame.msdu[2] == 20 or ii.frame.msdu[2] == 17 or ii.frame.msdu[2] == 16) and \
                ...
                if ((ii.frame.msdu[2] == 32 or ii.frame.msdu[2] == 37) and \
                    ii.frame.msdu[3] == redGun) or redHits == hitLimit: 
                    print 'RED target is DESTROYED!  Blue wins!'
                ...
                if ((ii.frame.msdu[2] == 32 or ii.frame.msdu[2] == 37) and \
                    ii.frame.msdu[3] == blueGun) or blueHits == hitLimit: 
                    blueHits += 1
                    print 'BLUE target is DESTROYED!  Red wins!'  
                    print 'kill shot by %i' % ii.frame.msdu[4]  
                    os.system('ipython GunSettings/endGame.py')  
                    if snifferDev.isRunning():
                        snifferDev.stop()
            ...
            if elapsedTime > timeLimit: 
                print 'time expired!'
                if redHits > blueHits: print 'RED wins!'
                if redHits < blueHits: print 'BLUE wins!'
                if redHits == blueHits:
                    print 'score tied!'
                    print 'next hit wins it'
                    hitLimit=redHits+1
                    timeLimit += 500
                    continue    
                os.system('ipython GunSettings/endGame.py')  
